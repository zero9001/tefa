...
send(msg.chat_id_, msg.id_,' ⌔┆اصدار سورس لارفين \n ⌔┆الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'⌔┆ عدد الكروبات الان » { '..#group..' }'..LARVINk..''..LARVIN..'\n⌔┆ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if LARVIN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌔┆العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceLarvine')..') \n ⌔┆'..LARVIN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⌔┆العضو : {["..data.first_name_.."](T.ME/SourceLarvine)}\n ⌔┆["..LARVIN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌔┆عذرا » {["..data.first_name_.."](T.ME/SourceLarvine)}\n ⌔┆عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
⌔┆[Source Channel](https://t.me/SourceLarvine/15)

⌔┆[TWS LARViN](http://t.me/vBvbot) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
⌔┆[Mtwr alswrus](http://t.me/VvBvV)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌔┆بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceLarvine')..') \n ⌔┆تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌔┆بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceLarvine')..') \n ⌔┆تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌔┆لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n ⌔┆تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌔┆العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌔┆العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌔┆العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SourceLarvine')..')'..'\n ⌔┆تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
-- vardump(data) 
LARVINdx(msg.chat_id_, msg.id_, ' ⌔┆ايدي المجموعة » ( '..msg.chat_id_..' )\n ⌔┆عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ⌔┆عدد المحظورين » ( *'..data.kicked_count_..' )*\n ⌔┆عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
⌔┆مسح الاساسين ← المنشئين الاساسين ⇠ قائمه المالك
 •━━━━━━𝑳𝐍━━━━━━•
...
send(msg.chat_id_, msg.id_, t..'ٴ⌔┆ٴ•━━━━━━𝑳𝐍━━━━━━•ٴ⌔┆○ٴ\n⌔┆彡 .[𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌](t.me/SourceLarvine)➢ ')
end
...
if LARVIN1_Msg then    
send(msg.chat_id_, msg.id_," ⌔┆"..LARVIN1_Msg)

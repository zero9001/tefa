...
send(chat,msg.id_," ▫️⁝  ملف نسخه ليس لهاذا البوت")
return false 
end      
...
send(chat,msg.id_,"\n ▫️⁝ تم رفع الملف بنجاح وتفعيل الكروبات\n ▫️⁝ ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
...
send(msg.chat_id_, msg.id_," ▫️⁝ تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
if SudoBot(msg) then
local bl = ' ▫️⁝ اهلا عزيزي آلمـطـور\n ▫️⁝ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ▫️⁝ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ▫️⁝ من خلاال الكيبورت خاص بك\n ▫️⁝ قناة سورس البوت [اضغط هنا](t.me/i600ik)'
local keyboard = {
{'الاحصائيات ▫️'},
{'تعطيل التواصل ▫️','تفعيل التواصل ▫️'},
{'ضع اسم للبوت ▫️','المطورين ▫️','قائمه العام ▫️'},
{'المشتركين ▫️','الكروبات ▫️'},
{'ضع كليشه ستارت ▫️','حذف كليشه ستارت ▫️'},
{'اذاعه ▫️','اذاعه خاص ▫️'},
{'اذاعه بالتثبيت ▫️','قائمه الكتم العام ▫️'},
{'تغير رساله الاشتراك','حذف رساله الاشتراك ▫️','تغير الاشتراك'},
{'اذاعه بالتوجيه ▫️','اذاعه بالتوجيه خاص ▫️'},
{'تفعيل الاشتراك الاجباري ▫️','تعطيل الاشتراك الاجباري ▫️'},
{'الاشتراك الاجباري ▫️','وضع قناة الاشتراك ▫️'},
{'تفعيل البوت الخدمي ▫️','تعطيل البوت الخدمي ▫️'},
{'تنظيف الكروبات ▫️','تنظيف المشتركين ▫️'},
{'جلب نسخه الاحتياطيه ▫️'},
{'تحديث السورس ▫️','الاصدار ▫️'},
{'معلومات السيرفر ▫️'},
{'الغاء ▫️'},
}
...
SourceLARVINr = ' ▫️⁝ اهلا عزيزي\n ▫️⁝ انا بوت اسمي ' ..Namebot..'\n ▫️⁝ اختصاصي حمايه الكروبات\n ▫️⁝ من تكرار والسبام والتوجيه والخ…\n ▫️⁝ لتفعيلي اتبع الاخطوات…↓\n ▫️⁝ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ▫️⁝ معرف المطور ['..UserName..']'
end 
...
if text == 'تفعيل البوت الخدمي ▫️' and SudoBot(msg) then  
...
if text == 'تعطيل البوت الخدمي ▫️' and SudoBot(msg) then  
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت ▫️' and SudoBot(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ▫️⁝ ارسل لي الكليشه الان')
return false
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تحديث السورس \n ▫️⁝ لديك اخر اصدار لسورس لارفين\n ▫️⁝ الاصدار » { 1.3v}')
dofile('LARVIN.lua')  
end
if text == 'الاصدار ▫️' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ▫️⁝ اصدار سورس لارفين \n ▫️⁝ الاصدار »{ 1.3v}')
end
if text == "ضع اسم للبوت ▫️" and SudoBot(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ▫️⁝ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ▫️' and SudoBot(msg) then 
...
if text == 'الكروبات ▫️' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ▫️⁝ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("قائمه العام ▫️") and SudoBot(msg) then
...
if text == ("قائمه الكتم العام ▫️") and SudoBot(msg) then
...
send(msg.chat_id_, msg.id_," ▫️⁝ ارسل الان اذاعتك؟ \n ▫️⁝ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ▫️" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ▫️⁝ ارسل الان اذاعتك؟ \n ▫️⁝ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ▫️" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ▫️⁝ ارسل الان اذاعتك؟ \n ▫️⁝ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ▫️" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ▫️⁝ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ▫️" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ▫️⁝ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ▫️' and SudoBot(msg) then 
GetFile_Bot(msg)
end
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'▫️⁝ عدد المشتركين الان » ( '..#pv..' )\n▫️⁝ تم ازالة » ( '..sendok..' ) من المشتركين\n▫️⁝  الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'▫️⁝ لا يوجد كروبات وهميه في البوت\n')   
else
local LARVIN = (w + q)
...
LARVIN = '\n▫️⁝ تم ازالة » { '..q..' } كروبات من البوت'
end
if w == 0 then
LARVINk = ''
else
LARVINk = '\n▫️⁝ تم ازالة » {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'▫️⁝  عدد الكروبات الان » { '..#group..' }'..LARVINk..''..LARVIN..'\n▫️⁝  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ▫️⁝ العضو » ['..result.title_..'](t.me/'..(username or 'i600ik')..')'
status  = '\n ▫️⁝ تم ترقيته مطور'
...
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
status  = '\n ▫️⁝ تم ترقيته مطور'
...
if LARVIN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ▫️⁝ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'i600ik')..') \n ▫️⁝ '..LARVIN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_, " ▫️⁝ تم حفظ الاسم")
return false
end 
...
send(msg.chat_id_, msg.id_," ▫️⁝ تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," ▫️⁝ تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," ▫️⁝ تمت الاذاعه الى >>{"..#list.."} كروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' ▫️⁝ عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تغيير صورة الكروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تغيير وصف الكروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," ▫️⁝ تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' ▫️⁝ تم حفظ ترحيب الكروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0," ▫️⁝ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ▫️⁝ ["..LARVIN_Msg.."] \n")
else
send(msg.chat_id_,0," ▫️⁝ العضو : {["..data.first_name_.."](T.ME/i600ik)}\n ▫️⁝ ["..LARVIN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " ▫️⁝ عذرا » {[@"..data.username_.."]}\n ▫️⁝ عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " ▫️⁝ عذرا » {["..data.first_name_.."](T.ME/i600ik)}\n ▫️⁝ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' ▫️⁝ عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,' ▫️⁝ عدد اعضاء الكروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ▫️⁝ بالتأكيد تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n ▫️⁝ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ▫️⁝ تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' ▫️⁝ تم تفعيل كروب جديده\n'..
'\n ▫️⁝ بواسطة {'..Name..'}'..
'\n ▫️⁝ ايدي الكروب {'..IdChat..'}'..
'\n ▫️⁝ اسم الكروب {['..NameChat..']}'..
'\n ▫️⁝ عدد اعضاء الكروب *{'..NumMember..'}*'..
'\n ▫️⁝ الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' ▫️⁝ بالتأكيد تم تعطيل الكروب')
else
sendText(msg.chat_id_,'\n ▫️⁝ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ▫️⁝ تم تعطيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n ▫️⁝ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ▫️⁝ تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تعيين عدد الاعضاء سيتم تفعيل الكروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ▫️" and SudoBot(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ▫️⁝ تم مسح رساله الاشتراك ")
return false  
end
...
if text == "تفعيل الاشتراك الاجباري ▫️" and SudoBot(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_," ▫️⁝ الاشتراك الاجباري مفعل \n ▫️⁝ على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," ▫️⁝ اهلا عزيزي المطور \n ▫️⁝ ارسل الان معرف قناتك")
end
return false  
end
...
send(msg.chat_id_, msg.id_, " ▫️⁝ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ▫️" and SudoBot(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ▫️⁝ تم تفعيل الاشتراك الاجباري \n ▫️⁝ على القناة » ["..addchusername.."]")
else
...
▫️⁝ LARViN TEAM
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
▫️⁝ [Source Files](http://t.me/SourceLarvine)

▫️⁝ [Source Channel](https://t.me/i600ik/15)

▫️⁝ [TWS LARViN](http://t.me/vBvbot) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
▫️⁝ [Mtwr alswrus](http://t.me/VvBvV)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' ▫️⁝ ارسل الامر الجديد')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ▫️⁝ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'i600ik')..') \n ▫️⁝ تـم قفـل الدردشه ')
end,nil)   
...
Text = '\n ▫️⁝ تم تعطيل نسبه الانوثه'
else
Text = '\n ▫️⁝ بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ▫️⁝ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'i600ik')..') \n ▫️⁝ تـم قفـل التاك بالكتم ')
end,nil)   
...
if #list == 0 then
t = " ▫️⁝ لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
send(msg.chat_id_, msg.id_," ▫️⁝ منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," ▫️⁝ لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," ▫️⁝ تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n ▫️⁝ قائمة مميزين الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ▫️⁝ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
status  = '\n ▫️⁝ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ▫️⁝ العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم مسح جميع المطايه')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n ▫️⁝ قائمة مطايه الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ▫️⁝ تم رفع العضو مطي في الكروب \n ▫️⁝ تعال حبي استلم العربانه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
status  = '\n ▫️⁝ تم تنزيل العضو مطي في الكروب\n ▫️⁝ تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ▫️⁝ تم رفع العضــو الحاته في الكروب \n ▫️⁝ تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
status  = '\n ▫️⁝ تم تنزيل العضــو الحاته من الكروب\n ▫️⁝ مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ▫️⁝ تم رفع العضــو الحات في الكروب \n ▫️⁝ تعال حبي الحات نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
status  = '\n ▫️⁝ تم تنزيل العضــو الحات من الكروب\n ▫️⁝ مشيي مو خوش حات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم تنزيل جميع صخوله من الكروب')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n ▫️⁝ قائمة صخوله الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
local  statuss  = '\n ▫️⁝ تم رفع المتهم صخل بالكروب\n ▫️⁝ الان اصبح صخل الكروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم تنزيل جميع جلاب الكروب')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n ▫️⁝ قائمة الجلاب الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
local  statuss  = '\n ▫️⁝ تم رفع جلب في الكروب\n ▫️⁝ تعال حبي اطيك عضمه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم تنزيل جميع القروده بالكروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
local  statuss  = '\n ▫️⁝ تم رفع حصان في الكروب\n ▫️⁝ تعال حبي احطلك سرج وركبك فرني فره حلوه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم تنزيل جميع البقرات بالكروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n ▫️⁝ قائمة البقرات الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
local  statuss  = '\n ▫️⁝ تم رفع بقره في الكروب\n ▫️⁝ ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
status  = '\n ▫️⁝ تم تنزيل بقره من الكروب\n ▫️⁝ تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم تنزيل جميع طليان بالكروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n ▫️⁝ قائمة الطليان الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
local  statuss  = '\n ▫️⁝ تم رفع الطلي في الكروب\n ▫️⁝ طلع برا ابو البعرور الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم تنزيل جميع زواحف')
end
if text == ("تاك للزواحف") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ▫️⁝ قائمة الزواحف الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
status  = '\n ▫️⁝ تم تنزيل زاحف من الكروب\n ▫️⁝ هاك حبي هاذا رقم مالك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم تنزيل جميع جريزي')
end
if text == ("تاك للجريذيه") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n ▫️⁝ قائمة الجريذيه الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
local  statuss  = '\n ▫️⁝ تم رفع جريذي في الكروب\n ▫️⁝ خايس ريحتك موتتنه روح سبح يع'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ▫️⁝ لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ▫️⁝ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n ▫️⁝  المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n ▫️⁝ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' ▫️⁝ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' ▫️⁝ انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ▫️⁝ لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ▫️⁝ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ▫️⁝ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
status  = '\n ▫️⁝ تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ▫️⁝ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ▫️⁝ لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
status  = '\n ▫️⁝ تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'pvv_v')..')'
status  = '\n ​▫️⁝ الايدي » '..result.sender_user_id_..'\n ▫️⁝  تم رفعه مشرف بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
...
usertext = '\n ▫️⁝  العضو » ['..result.title_..'](t.me/'..(username or 'pvv_v')..')'
status  = '\n ▫️⁝  تم رفعه مشرف بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
...
send(msg.chat_id_,msg.id_," ▫️⁝ عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," ▫️⁝ تم تثبيت الرساله")   
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," ▫️⁝ تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"▫️⁝ تم الغاء تثبيت الكل")   
...
send(msg.chat_id_, msg.id_," ▫️⁝ تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم ازالة صورة الكروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ ارسل الان الوصف')
end
return false  
end
...
GetWelcome = ' ▫️⁝ لم يتم تعيين ترحيب للكروب'
end 
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تفعيل ترحيب الكروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تعطيل ترحيب الكروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' ▫️⁝ تم ازالة ترحيب الكروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," ▫️⁝ ارسل الكلمه لمنعها")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," ▫️⁝ تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_," ▫️⁝ تم الغاء منعها")  
database:del(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم مسح قائمه منع المتحركات')  
end
if text == 'مسح قائمه منع الصور' and Manager(msg) then     
database:del(bot_id.."filterphoto"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' ▫️⁝ تم مسح قائمه منع الصور')  
end
if text == 'مسح قائمه منع الملصقات' and Manager(msg) then     
database:del(bot_id.."filtersteckr"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' ▫️⁝ تم مسح قائمه منع الملصقات')  
end
------------------

if text == 'مسح كليشه المطور' and SudoBot(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ▫️⁝ تم مسح كليشه المطور')
end
...
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' ▫️⁝ تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم ازالة كليشة الايدي')
end
return false  
end 
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " ▫️⁝ لا توجد بوتات في الكروب")
else
local t = ' ▫️⁝ عدد البوتات هنا >> {'..c..'}\n ▫️⁝ عدد البوتات التي هي ادمن >> {'..x..'}\n ▫️⁝ تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
local f = ' ▫️⁝ عدد البوتات التي هي ادمن >> {'..t..'}\n ▫️⁝ ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
send(msg.chat_id_, msg.id_," ▫️⁝ تم حفظ قوانين الكروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," ▫️⁝ ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," ▫️⁝ تم ازالة قوانين الكروب")  
...
send(msg.chat_id_, msg.id_," ▫️⁝ لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم طرد المحذوفين')
end,nil)
end
end
...
send(msg.chat_id_, msg.id_, " ▫️⁝ ارسل نوع الرتبه \n ▫️⁝ {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ▫️⁝ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'i600ik')..')'..'\n ▫️⁝ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' ▫️⁝ عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'▫️⁝تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_, msg.id_,'▫️⁝ تم تنظيف جميع الرسائل المعدله')
end
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," ▫️⁝ ليست لدي صلاحية تغير اسم الكروب")  
else
sebd(msg.chat_id_,msg.id_,' ▫️⁝ تم تغيير اسم الكروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"\n ▫️⁝ تم تنزيل الشخص من الرتب التاليه \n ▫️⁝ { "..dev..''..cu..''..crr..''..cr..''..own..''..mod..''..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n ▫️⁝  عذرا العضو لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم حفظ الرد')
return false  
end  
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' ▫️⁝ ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' ▫️⁝ ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_,' ▫️⁝ ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' ▫️⁝ المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ رتبتك في البوت » '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' ▫️⁝ ايديك » '..msg.sender_user_id_)
end
if text == 'الرتبه' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'i600ik')..')'
local iduser = result.sender_user_id_
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," ▫️⁝ البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local amir = ' ▫️⁝ عدد الادمنيه : '..data.administrator_count_..
'\n\n ▫️⁝ عدد المطرودين : '..data.kicked_count_..
'\n\n ▫️⁝ عدد الاعضاء : '..data.member_count_..
'\n\n ▫️⁝ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
...
send(msg.chat_id_, msg.id_, '\n ▫️⁝ عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ عذرا لا استطيع طرد ادمنية الكروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' ▫️⁝ تم طردك من الكروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' ▫️⁝ لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' ▫️⁝ لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' ▫️⁝ تعال حبي يصيحونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝ انت منشئ الكروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ▫️⁝ الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' ▫️⁝ انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' ▫️⁝ تم تعطيل امر منو ضافني') 
end
end
...
send(msg.chat_id_, msg.id_,'▫️⁝ تم تغير الايدي ارسل ايدي لرؤيته')
end
...
local rtpg = rtpa
local amira = {
" ▫️⁝ اروح فـدوه للـحلوين",
" ▫️⁝ فديت الصاك محح",
" ▫️⁝ فـدشـي عمـي",
" ▫️⁝ دغـيرهـا شبـي هـاذ",
" ▫️⁝ شهل الگيمر ",
" ▫️⁝ شهل الصوره تخمبش ",
" ▫️⁝ فديت الحلو ",
" ▫️⁝ بـبكن حـلك ",
...
send(msg.chat_id_, msg.id_,' ▫️⁝ تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' ▫️⁝ تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' ▫️⁝ لم تقم بأضافه احد'
else
Text = ' ▫️⁝ عدد جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," ▫️⁝ تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' ▫️⁝ لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' ▫️⁝ عدد نقاطك التي ربحتها هيه *» { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* ▫️⁝ لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' ▫️⁝ ليس لديك نقاط في الالعاب\n ▫️⁝ اذا كنت تريد ربح نقاط \n ▫️⁝ ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n ▫️⁝ ليس لديك نقاط في هذه لعبه \n ▫️⁝ لزيادة نقاطك في اللعبه \n ▫️⁝ ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' ▫️⁝ تم خصم *» { '..NUMPY..' }* من نقاطك \n ▫️⁝ وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n ▫️⁝ اهلا عزيزي البوت هنا ادمن'..'\n ▫️⁝ وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\n ▫️⁝ تغير معلومات الكروب ↞ ❴ '..info..' ❵'..'\n ▫️⁝ حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n ▫️⁝ حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n ▫️⁝ دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n ▫️⁝ تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n ▫️⁝ اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," ▫️⁝ تم تغير رد المطور الى » "..Teext)
end
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم استعادة الاوامر القديمه')
end
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ الان يمكنك ارسال الكليشه م1')
database:set(bot_id..'help1'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م2' and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' ▫️⁝ الان يمكنك ارسال الكليشه م2')
...
Text = [[
*▫️اهلا انتツفي اوامر البوت▫️*
ٴ•━━━━━━𝑳𝐍━━━━━━•ٴ
*▫️م1 ◂ اوامر الحمايه*
*▫️م2 ◂ اوامر تعطيل ~ تفعيل*
*▫️م3 ◂ اوامر ضع ~ اضف*
*▫️م4 ◂ اوامر مسح ~ حذف*
*▫️م5 ◂ اوامر تنزيل+رفع+التغير*
*▫️م6 ◂ اوامر الكروب*
*▫️م7 ◂ اوامر التحشيش*
*▫️م8 ◂ اوامر مطور البوت*
*▫️م9 ◂ اوامر مطور الاساسي* 
*▫️م10 ◂ اوامر الاعضاء*
ٴ•━━━━━━𝑳𝐍━━━━━━•ٴ
...
▫️⁝ البوتات
▫️⁝ صلاحيه
▫️⁝ قائمه منع المتحركات
▫️⁝ قائمه منع الصور
▫️⁝ قائمه منع الملصقات
▫️⁝ مسح قائمه المنع
▫️⁝ المحذوفين
•━━━━━━𝑳𝐍━━━━━━•
▫️⁝ حذف + امر ...
...
▫️⁝ ~ الصور + متحركه + ملصق ~
▫️⁝ حظر ~ كتم ~ تقيد ~ طرد
▫️⁝ المحظورين ~ المكتومين ~ المقيدين
▫️⁝ الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
▫️⁝ تقيد ~ كتم + الرقم + ساعه
▫️⁝ تقيد ~ كتم + الرقم + يوم
▫️⁝ تقيد ~ كتم + الرقم + دقيقه
▫️⁝ تثبيت ~ الغاء تثبيت
▫️⁝ الغاء تثبيت الكل
▫️⁝ الترحيب
▫️⁝ كشف البوتات
...
▫️⁝ اوامر المطورين 
 •━━━━━━𝑳𝐍━━━━━━•
▫️⁝ تفعيل ← تعطيل 
▫️⁝ المجموعات ← المشتركين ← الاحصائيات
▫️⁝ رفع ⇠ تنزيل مالك
▫️⁝ رفع ← تنزيل منشئ اساسي
▫️⁝ مسح الاساسين ← المنشئين الاساسين ⇠ قائمه المالك
 •━━━━━━𝑳𝐍━━━━━━•
...
send(msg.chat_id_, msg.id_,' ▫️⁝الف مبروك لقد فزت \n ▫️⁝للعب مره اخره ارسل »{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' ▫️⁝مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n ▫️⁝لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ')
...
•━━━━━━𝑳𝐍━━━━━━•
 ▫️⁝ تفعيل الالعاب • لتفعيل العبه ° 
 ▫️⁝ تعطيل الالعاب • لتعطيل العبه °
•━━━━━━𝑳𝐍━━━━━━•
 ▫️⁝ الالعاب الخاصه بسورس 
•━━━━━━𝑳𝐍━━━━━━•
 ▫️⁝ لعبه البات ~⪼ لعبة المحيبس 
 ▫️⁝ لعبه التخمين ~⪼ لعبة البحث
 ▫️⁝ لعبه الاسرع ~⪼ لعبة اسرع شخص
 ▫️⁝ لعبه السمايلات ~⪼ لعبة المطابقه 
 ▫️⁝ لعبه المختلف ~⪼ لعبة الذكاء
 ▫️⁝ لعبه الرياضيات ~⪼ لعبة الارقام
 ▫️⁝ لعبه الانكليزي ~⪼ لعبة ترجمه
 ▫️⁝ لعبه الامثله ~⪼ لعبة تصحيح 
 ▫️⁝ لعبه العكس ~⪼ لعبة عكس الكلمات
 ▫️⁝ لعبه الحزوره ~⪼لعبة التفكير 
 ▫️⁝ لعبه المعاني ~⪼ العبه الشهيره 
•━━━━━━𝑳𝐍━━━━━━•
彡 .[𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌](t.me/i600ik)➢
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ▫️⁝ٴ•━━━━━━𝑳𝐍━━━━━━•ٴ▫️⁝○ٴ\n▫️⁝ 彡 .[𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌](t.me/i600ik)➢ ')
end
...
send(msg.chat_id_, msg.id_, '▫️⁝ تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,'▫️⁝ تم تفعيل حساب العمر')
...
t =[[
رابط الحذف في جميع مواقع التواصل ▫️
فكر قبل لا تتسرع وتروح
•━━━━━━𝑳𝐍━━━━━━•
 ▫️ رابط حذف  [Telegram](https://my.telegram.org/auth?to=delete) ܁
 ▫️ رابط حذف [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 ▫️ رابط حذف [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 ▫️ رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
send(msg.chat_id_, msg.id_, ' ▫️⁝ تم تعطيل اوامر التحشيش')
...
send(msg.chat_id_,0,''..t..'\n•━━━━━━𝑳𝐍━━━━━━•\n ▫️⁝ تم التعديل على الميديا\n ▫️⁝ الشخص الي قام بالتعديل\n ▫️⁝ ايدي الشخص ◂ '..result.sender_user_id_..'\n ▫️⁝ معرف الشخص»{ '..users..' }') 
end,nil)
...
if LARVIN1_Msg then    
send(msg.chat_id_, msg.id_," ▫️⁝ "..LARVIN1_Msg)

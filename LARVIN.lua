...
send(chat,msg.id_," .𖣂┆ ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," .𖣂┆ جاري ...\n .𖣂┆ رفع الملف الان")
else
send(chat,msg.id_,"* .𖣂┆عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n .𖣂┆تم رفع الملف بنجاح وتفعيل الكروبات\n .𖣂┆ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n .𖣂┆العضــو » '..Name..'\n .𖣂┆قام بالتكرار هنا وتم طرده '  
...
--------------------------------------------------------------------------------------------------------------
function SourceLARVIN(msg,data) -- بداية العمل
if msg then
...
if text == "الغاء" or text == "الغاء .𖣂┆" then   
send(msg.chat_id_, msg.id_," .𖣂┆تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," .𖣂┆تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' .𖣂┆لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n  .𖣂┆اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if SudoBot(msg) then
local bl = ' .𖣂┆اهلا عزيزي آلمـطـور\n .𖣂┆آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n .𖣂┆تسـتطـيع‌‏ آلتحگم باوامر البوت\n .𖣂┆من خلاال الكيبورت خاص بك\n .𖣂┆قناة سورس البوت [اضغط هنا](t.me/SourceLarvine)'
local keyboard = {
{'الاحصائيات .𖣂┆'},
{'تعطيل التواصل .𖣂┆','تفعيل التواصل .𖣂┆'},
{'ضع اسم للبوت .𖣂┆','المطورين .𖣂┆','قائمه العام .𖣂┆'},
{'المشتركين .𖣂┆','الكروبات .𖣂┆'},
{'ضع كليشه ستارت .𖣂┆','حذف كليشه ستارت .𖣂┆'},
{'اذاعه .𖣂┆','اذاعه خاص .𖣂┆'},
{'اذاعه بالتثبيت .𖣂┆','قائمه الكتم العام .𖣂┆'},
{'تغير رساله الاشتراك','حذف رساله الاشتراك .𖣂┆','تغير الاشتراك'},
{'اذاعه بالتوجيه .𖣂┆','اذاعه بالتوجيه خاص .𖣂┆'},
{'تفعيل الاشتراك الاجباري .𖣂┆','تعطيل الاشتراك الاجباري .𖣂┆'},
{'الاشتراك الاجباري .𖣂┆','وضع قناة الاشتراك .𖣂┆'},
{'تفعيل البوت الخدمي .𖣂┆','تعطيل البوت الخدمي .𖣂┆'},
{'تنظيف الكروبات .𖣂┆','تنظيف المشتركين .𖣂┆'},
{'جلب نسخه الاحتياطيه .𖣂┆'},
{'تحديث السورس .𖣂┆','الاصدار .𖣂┆'},
{'معلومات السيرفر .𖣂┆'},
{'الغاء .𖣂┆'},
}
...
SourceLARVINr = ' .𖣂┆اهلا عزيزي\n .𖣂┆انا بوت اسمي ' ..Namebot..'\n .𖣂┆اختصاصي حمايه الكروبات\n .𖣂┆من تكرار والسبام والتوجيه والخ…\n .𖣂┆لتفعيلي اتبع الاخطوات…↓\n .𖣂┆اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ .𖣂┆معرف المطور ['..UserName..']'
end 
send(msg.chat_id_, msg.id_, SourceLARVINr) 
end
end
...
send(msg.sender_user_id_, msg.id_,' .𖣂┆تم ارسال رسالتك\n .𖣂┆سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' .𖣂┆تم ارسال الملصق من ↓\n - '..Name
...
local Text = ' .𖣂┆المستخدم » '..Name..'\n .𖣂┆تم حظره من التواصل'
...
local LARVIN_Msg = '\n .𖣂┆قام الشخص بحظر البوت'
send(msg.chat_id_, msg.id_,LARVIN_Msg) 
return false  
end 
if text then    
send(id_user,msg.id_,text)    
local Name = '['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..id_user..')'
local Text = ' .𖣂┆المستخدم » '..Name..'\n .𖣂┆تم ارسال الرساله اليه'
sendText(SUDO,Text,msg.id_/2097152/0.5,'md')
return false
end    
...
if text == 'تفعيل التواصل .𖣂┆' and SudoBot(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n .𖣂┆تم تفعيل التواصل ' 
else
Text = '\n .𖣂┆بالتاكيد تم تفعيل التواصل '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التواصل .𖣂┆' and SudoBot(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n .𖣂┆تم تعطيل التواصل' 
else
Text = '\n .𖣂┆بالتاكيد تم تعطيل التواصل'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل البوت الخدمي .𖣂┆' and SudoBot(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n .𖣂┆تم تفعيل البوت الخدمي ' 
else
Text = '\n .𖣂┆بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل البوت الخدمي .𖣂┆' and SudoBot(msg) then  
if not database:get(bot_id..'Free:Bots') then
database:set(bot_id..'Free:Bots',true) 
Text = '\n .𖣂┆تم تعطيل البوت الخدمي' 
else
Text = '\n .𖣂┆بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء .𖣂┆' then   
send(msg.chat_id_, msg.id_,' .𖣂┆الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' .𖣂┆تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت .𖣂┆' and SudoBot(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت .𖣂┆' and SudoBot(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' .𖣂┆تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر .𖣂┆' and SudoBot(msg) then 
...
if text == 'تحديث السورس .𖣂┆' and SudoBot(msg) then 
os.execute('rm -rf LARVIN.lua')
os.execute('wget https://raw.githubusercontent.com/LARVINNTEAM/LARVIN/main/LARVIN.lua')
send(msg.chat_id_, msg.id_,' .𖣂┆تم تحديث السورس \n .𖣂┆لديك اخر اصدار لسورس لارفين\n .𖣂┆الاصدار » { 1.3v}')
dofile('LARVIN.lua')  
end
if text == 'الاصدار .𖣂┆' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' .𖣂┆اصدار سورس لارفين \n .𖣂┆الاصدار »{ 1.3v}')
end
if text == "ضع اسم للبوت .𖣂┆" and SudoBot(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," .𖣂┆ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات .𖣂┆' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' الاحصائيات .𖣂┆\n'..' .𖣂┆عدد الكروبات » {'..Groups..'}'..'\n .𖣂┆ عدد المشتركين » {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
if text == 'المشتركين .𖣂┆' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n .𖣂┆المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات .𖣂┆' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n .𖣂┆الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين .𖣂┆") and SudoBot(msg) then
...
if text == ("قائمه العام .𖣂┆") and SudoBot(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n .𖣂┆قائمه المحظورين عام \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " .𖣂┆لا يوجد محظورين عام"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text == ("قائمه الكتم العام .𖣂┆") and SudoBot(msg) then
local list = database:smembers(bot_id..'Gmute:User')
t = "\n .𖣂┆قائمة المكتومين عام \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " .𖣂┆لا يوجد مكتومين عام"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text=="اذاعه خاص .𖣂┆" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," .𖣂┆ارسل الان اذاعتك؟ \n .𖣂┆للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه .𖣂┆" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," .𖣂┆ارسل الان اذاعتك؟ \n .𖣂┆للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت .𖣂┆" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," .𖣂┆ارسل الان اذاعتك؟ \n .𖣂┆للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه .𖣂┆" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," .𖣂┆ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص .𖣂┆" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," .𖣂┆ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه .𖣂┆' and SudoBot(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين .𖣂┆" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
else
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي .𖣂┆•\n• لايمكنك استخدام البوت .𖣂┆•\n• عليك الاشتراك في القناة .𖣂┆•\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'.𖣂┆لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'.𖣂┆عدد المشتركين الان » ( '..#pv..' )\n.𖣂┆تم ازالة » ( '..sendok..' ) من المشتركين\n.𖣂┆ الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if text == "تنظيف الكروبات .𖣂┆" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'.𖣂┆لا يوجد كروبات وهميه في البوت\n')   
else
local LARVIN = (w + q)
local sendok = #group - LARVIN
if q == 0 then
LARVIN = ''
else
LARVIN = '\n.𖣂┆تم ازالة » { '..q..' } كروبات من البوت'
end
if w == 0 then
LARVINk = ''
else
LARVINk = '\n.𖣂┆تم ازالة » {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'.𖣂┆ عدد الكروبات الان » { '..#group..' }'..LARVINk..''..LARVIN..'\n.𖣂┆ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆لا تستطيع استخدام البوت \n  .𖣂┆يرجى الاشتراك بالقناه اولا \n  .𖣂┆اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_,msg.id_," .𖣂┆عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n .𖣂┆العضو » ['..result.title_..'](t.me/'..(username or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم ترقيته مطور'
texts = usertext..status
else
texts = ' .𖣂┆لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم ترقيته مطور'
...
local LARVIN1_Msg = database:get(bot_id.."LARVIN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if LARVIN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' .𖣂┆العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceLarvine')..') \n .𖣂┆'..LARVIN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء .𖣂┆' then   
send(msg.chat_id_, msg.id_," .𖣂┆تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " .𖣂┆تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء .𖣂┆' then   
send(msg.chat_id_, msg.id_," .𖣂┆تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_," .𖣂┆تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," .𖣂┆تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," .𖣂┆تمت الاذاعه الى >>{"..#list.."} كروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " .𖣂┆تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, ' .𖣂┆المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' .𖣂┆عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' .𖣂┆عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' .𖣂┆البوت ادمن في القناة \n .𖣂┆تم تفعيل الاشتراك الاجباري في \n .𖣂┆ايدي القناة ('..data.id_..')\n .𖣂┆معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' .𖣂┆عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆… عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' .𖣂┆تم تغيير صورة الكروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," .𖣂┆تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' .𖣂┆تم تغيير وصف الكروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," .𖣂┆تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' .𖣂┆تم حفظ ترحيب الكروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," .𖣂┆تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_," .𖣂┆تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
--------------------------------------------------------------------------------------------------------------
if LARVIN_Msg and not Special(msg) then  
local LARVIN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if LARVIN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," .𖣂┆العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n .𖣂┆["..LARVIN_Msg.."] \n")
else
send(msg.chat_id_,0," .𖣂┆العضو : {["..data.first_name_.."](T.ME/SourceLarvine)}\n .𖣂┆["..LARVIN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " .𖣂┆عذرا » {[@"..data.username_.."]}\n .𖣂┆عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " .𖣂┆عذرا » {["..data.first_name_.."](T.ME/SourceLarvine)}\n .𖣂┆عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' .𖣂┆عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,' .𖣂┆عدد اعضاء الكروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' .𖣂┆بالتأكيد تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n .𖣂┆بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n .𖣂┆تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' .𖣂┆تم تفعيل كروب جديده\n'..
'\n .??┆بواسطة {'..Name..'}'..
'\n .𖣂┆ايدي الكروب {'..IdChat..'}'..
'\n .𖣂┆اسم الكروب {['..NameChat..']}'..
'\n .𖣂┆عدد اعضاء الكروب *{'..NumMember..'}*'..
'\n .𖣂┆الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' .𖣂┆بالتأكيد تم تعطيل الكروب')
else
sendText(msg.chat_id_,'\n .𖣂┆بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n .𖣂┆تم تعطيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' .𖣂┆تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n .𖣂┆بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n .𖣂┆تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم تعيين عدد الاعضاء سيتم تفعيل الكروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
send(msg.chat_id_, msg.id_, ' .𖣂┆حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and SudoBot(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' .𖣂┆حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك .𖣂┆" and SudoBot(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " .𖣂┆تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك .𖣂┆$") and SudoBot(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' .𖣂┆حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري .𖣂┆" and SudoBot(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_," .𖣂┆الاشتراك الاجباري مفعل \n .𖣂┆على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," .𖣂┆اهلا عزيزي المطور \n .𖣂┆ارسل الان معرف قناتك")
end
return false  
end
if text == "تعطيل الاشتراك الاجباري .𖣂┆" and SudoBot(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " .𖣂┆تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري .𖣂┆" and SudoBot(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " .𖣂┆تم تفعيل الاشتراك الاجباري \n .𖣂┆على القناة » ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " .𖣂┆لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
...
.𖣂┆LARViN TEAM
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
.𖣂┆[Source Files](http://t.me/SourceLarvine)

.𖣂┆[Source Channel](https://t.me/SourceLarvine/15)

.𖣂┆[TWS LARViN](http://t.me/vBvbot) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
.𖣂┆[Mtwr alswrus](http://t.me/VvBvV)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم حفظ الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' .𖣂┆بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceLarvine')..') \n .𖣂┆تـم قفـل الدردشه ')
end,nil)   
...
Text = ' .𖣂┆تم تفعيل نسبه الحب'
database:del(bot_id..'Cick:lov'..msg.chat_id_)  
else
Text = ' .𖣂┆بالتاكيد تم تفعيل نسبه الحب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n .𖣂┆تم تعطيل نسبه الانوثه'
else
Text = '\n .𖣂┆بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل @all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' .𖣂┆تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' .𖣂┆بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' .𖣂┆بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceLarvine')..') \n .𖣂┆تـم قفـل التاك بالتقييد ')
end,nil)   
elseif text == 'قفل التاك بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' .𖣂┆بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceLarvine')..') \n .𖣂┆تـم قفـل التاك بالكتم ')
end,nil)   
elseif text == 'قفل التاك بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' .𖣂┆بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceLarvine')..') \n .𖣂┆تـم قفـل التاك بالطرد ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " .𖣂┆لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " .𖣂┆لا تسطيع حظر البوت عام")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " .𖣂┆لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " .𖣂┆لا تسطيع كتم البوت عام")
return false 
end
...
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم الغاء (الحظر-الكتم) عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n .𖣂┆تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and SudoBot(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n .𖣂┆قائمة مطورين البوت \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " .𖣂┆لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text == ("صيح للمالك") or text == ("المالك") then
local list = database:smembers(bot_id..'CoSu'..msg.chat_id_)
t = "\n .𖣂┆وينكم تعالو يريدوكم بكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- {[@"..username.."]}\n"
...
send(msg.chat_id_, msg.id_," .𖣂┆منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," .𖣂┆لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," .𖣂┆تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' .𖣂┆تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم مسح المنظفيه')
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " .𖣂┆لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' .𖣂┆ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' .𖣂┆البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
...
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, ' .𖣂┆لا يوجد حساب بهاذا المعرف')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n .𖣂┆قائمة مميزين الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n .𖣂┆لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n .𖣂┆العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم مسح جميع المطايه')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n .𖣂┆قائمة مطايه الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n .𖣂┆تم رفع العضو مطي في الكروب \n .𖣂┆تعال حبي استلم العربانه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم تنزيل العضو مطي في الكروب\n .𖣂┆تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n .𖣂┆تم رفع العضــو الحاته في الكروب \n .𖣂┆تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم تنزيل العضــو الحاته من الكروب\n .𖣂┆مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n .𖣂┆تم رفع العضــو الحات في الكروب \n .𖣂┆تعال حبي الحات نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم تنزيل العضــو الحات من الكروب\n .𖣂┆مشيي مو خوش حات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم تنزيل جميع صخوله من الكروب')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n .𖣂┆قائمة صخوله الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
local  statuss  = '\n .𖣂┆تم رفع المتهم صخل بالكروب\n .𖣂┆الان اصبح صخل الكروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم تنزيل جميع جلاب الكروب')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n .𖣂┆قائمة الجلاب الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
local  statuss  = '\n .𖣂┆تم رفع جلب في الكروب\n .𖣂┆تعال حبي اطيك عضمه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم تنزيل جميع القروده بالكروب')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n .𖣂┆قائمة القروده الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
local  statuss  = '\n .𖣂┆تم رفع قرد في الكروب\n .𖣂┆تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
local  statuss  = '\n .𖣂┆تم رفع حصان في الكروب\n .𖣂┆تعال حبي احطلك سرج وركبك فرني فره حلوه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم تنزيل جميع البقرات بالكروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n .𖣂┆قائمة البقرات الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
local  statuss  = '\n .𖣂┆تم رفع بقره في الكروب\n .𖣂┆ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم تنزيل بقره من الكروب\n .𖣂┆تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم تنزيل جميع طليان بالكروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n .𖣂┆قائمة الطليان الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
local  statuss  = '\n .𖣂┆تم رفع الطلي في الكروب\n .𖣂┆طلع برا ابو البعرور الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم تنزيل جميع زواحف')
end
if text == ("تاك للزواحف") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n .𖣂┆قائمة الزواحف الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم تنزيل زاحف من الكروب\n .𖣂┆هاك حبي هاذا رقم مالك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم تنزيل جميع جريزي')
end
if text == ("تاك للجريذيه") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n .𖣂┆قائمة الجريذيه الكروب \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
local  statuss  = '\n .𖣂┆تم رفع جريذي في الكروب\n .𖣂┆خايس ريحتك موتتنه روح سبح يع'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' .𖣂┆تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " .𖣂┆لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," .𖣂┆عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n .𖣂┆ المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n .𖣂┆تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' .𖣂┆ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' .𖣂┆انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " .𖣂┆لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' .𖣂┆البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," .𖣂┆عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' .𖣂┆البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " .𖣂┆لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n .𖣂┆ الايدي » `'..result.sender_user_id_..'`\n .𖣂┆ تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'pvv_v')..')'
status  = '\n ​.𖣂┆الايدي » '..result.sender_user_id_..'\n .𖣂┆ تم رفعه مشرف بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
...
usertext = '\n .𖣂┆ العضو » ['..result.title_..'](t.me/'..(username or 'pvv_v')..')'
status  = '\n .𖣂┆ تم رفعه مشرف بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n .𖣂┆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'pvv_v')..')'
status  = '\n .𖣂┆ الايدي » '..result.sender_user_id_..'\n .𖣂┆ تم تنزيله ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
local text = 
'\n .𖣂┆اعدادات الكروب كتالي √↓'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n .𖣂┆ علامة ال {✓} تعني معطل'..
'\n .𖣂┆ علامة ال {✘} تعني مفعل'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n .𖣂┆ الروابط » { '..lock_links..
' }\n'..' .𖣂┆ المعرفات » { '..lock_user..
' }\n'..' .𖣂┆ التاك » { '..lock_hash..
' }\n'..' .𖣂┆ البوتات » { '..lock_bots..
' }\n'..' .𖣂┆ التوجيه » { '..lock_fwd..
' }\n'..' .𖣂┆ التثبيت » { '..lock_pin..
' }\n'..' .𖣂┆ الاشعارات » { '..lock_tagservr..
' }\n'..' .𖣂┆ الماركدون » { '..lock_mark..
' }\n'..' .𖣂┆ التعديل » { '..lock_edit..
' }\n'..' .𖣂┆ تعديل الميديا » { '..lock_edit_med..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..' .𖣂┆ الكلايش » { '..lock_spam..
' }\n'..' .𖣂┆ الكيبورد » { '..lock_inlin..
' }\n'..' .𖣂┆ الاغاني » { '..lock_vico..
' }\n'..' .𖣂┆ المتحركه » { '..lock_gif..
' }\n'..' .𖣂┆ الملفات » { '..lock_file..
' }\n'..' .𖣂┆ الدردشه » { '..lock_text..
...
' }\n'..' .𖣂┆ التكرار » { '..flood..
' }\n'..' .𖣂┆ الترحيب » { '..welcome..
' }\n'..' .𖣂┆ عدد التكرار » { '..NUM_MSG_MAX..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n .𖣂┆ علامة ال {✓} تعني مفعل'..
'\n .𖣂┆ علامة ال {✘} تعني معطل'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..' .𖣂┆ امر صيح » { '..kickme..
' }\n'..' .𖣂┆ امر اطردني » { '..sehuser..
' }\n'..' .𖣂┆ امر منو ضافني » { '..addme..
' }\n'..' .𖣂┆ ردود المدير » { '..rdmder..
' }\n'..' .𖣂┆ ردود المطور » { '..rdsudo..
' }\n'..' .𖣂┆ الايدي » { '..idgp..
' }\n'..' .𖣂┆ الايدي بالصوره » { '..idph..
' }\n'..' .𖣂┆ الرفع » { '..setadd..
' }\n'..' .𖣂┆ الحظر » { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n .𖣂┆ CH » @SourceLarvine\n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," .𖣂┆عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," .𖣂┆تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," .𖣂┆انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," .𖣂┆لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," .𖣂┆ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," .𖣂┆عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," .𖣂┆تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,".𖣂┆تم الغاء تثبيت الكل")   
...
send(msg.chat_id_,msg.id_," .𖣂┆حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_," .𖣂┆تم تفعيل الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," .𖣂┆تم تعطيل الرابط") 
return false end
end
...
send(msg.chat_id_, msg.id_," .𖣂┆تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," .𖣂┆تم تعطيل الصوره") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."Link_Group:status"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_," .𖣂┆الرابط معطل") 
return false  
end
...
linkgp = ' .𖣂┆لا يوجد رابط ارسل ضع رابط'
end  
...
send(msg.chat_id_,msg.id_," .𖣂┆تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم ازالة صورة الكروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل الان الوصف')
end
return false  
end
...
t  = ' .𖣂┆ارسل لي الترحيب الان'
tt = '\n .𖣂┆تستطيع اضافة مايلي !\n .𖣂┆دالة عرض الاسم »{`name`}\n .𖣂┆دالة عرض المعرف »{`user`}'
...
GetWelcome = ' .𖣂┆لم يتم تعيين ترحيب للكروب'
end 
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم تفعيل ترحيب الكروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم تعطيل ترحيب الكروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' .𖣂┆تم ازالة ترحيب الكروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," .𖣂┆ارسل الكلمه لمنعها")  
database:set(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," .𖣂┆ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."LARVIN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."LARVIN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," .𖣂┆تم منع الكلمه مع التحذير")  
database:del(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LARVIN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."LARVIN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."LARVIN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," .𖣂┆ارسل الكلمه الان")  
database:set(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," .𖣂┆تم الغاء منعها")  
database:del(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LARVIN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."LARVIN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."LARVIN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."LARVIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LARVIN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."LARVIN1:List:Filter"..msg.chat_id_,v)  
end  
send(msg.chat_id_, msg.id_," .𖣂┆تم مسح قائمه المنع")  
end
...
t = "\n .𖣂┆قائمة المنع \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do  
local LARVIN_Msg = database:get(bot_id.."LARVIN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..LARVIN_Msg.."}\n"    
end  
if #list == 0 then  
t = " .𖣂┆لا يوجد كلمات ممنوعه"  
end  
send(msg.chat_id_, msg.id_,t)  
end  
...
send(msg.chat_id_,msg.id_,' .𖣂┆تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' .𖣂┆تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," .𖣂┆تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " .𖣂┆لا توجد بوتات في الكروب")
else
local t = ' .𖣂┆عدد البوتات هنا >> {'..c..'}\n .𖣂┆عدد البوتات التي هي ادمن >> {'..x..'}\n .𖣂┆تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n•━━━━━━𝑳𝐍━━━━━━•\n .𖣂┆عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' .𖣂┆عدد البوتات التي هي ادمن >> {'..t..'}\n .𖣂┆ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " .𖣂┆تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," .𖣂┆تم حفظ قوانين الكروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," .𖣂┆ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," .𖣂┆تم ازالة قوانين الكروب")  
...
send(msg.chat_id_, msg.id_," .𖣂┆لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' .𖣂┆لا توجد صلاحيات مضافه')
return false
end
t = "\n .𖣂┆قائمة الصلاحيات المضافه \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " .𖣂┆ارسل نوع الرتبه \n .𖣂┆{عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* .𖣂┆تم مسح الصلاحيه *\n") 
end
...
send(msg.chat_id_, msg.id_"* .𖣂┆تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n .𖣂┆ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* .𖣂┆تستطيع اضافه صلاحيات {مميز - عضو} \n .𖣂┆ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* .𖣂┆ تستطيع اضافه صلاحيات {عضو} \n .𖣂┆ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " .𖣂┆تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n .𖣂┆العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SourceLarvine')..')'..'\n .𖣂┆تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' .𖣂┆عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'.𖣂┆تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'.𖣂┆تم حذف {'..num..'}')  
...
local Message = v
if Message then
t = ".𖣂┆تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."VVVZVV:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = ".𖣂┆لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = ".𖣂┆عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = ".𖣂┆لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,'.𖣂┆تم تنظيف جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," .𖣂┆ارسل لي الاسم الان ")  
end
return false
end

if text == ""..(database:get(bot_id..'Name:Bot') or 'لارفين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'لارفين')
local LARVIN_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..LARVIN_Msg[math.random(#LARVIN_Msg)]..']') 
return false
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," .𖣂┆ليست لدي صلاحية تغير اسم الكروب")  
else
sebd(msg.chat_id_,msg.id_,' .𖣂┆تم تغيير اسم الكروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," .𖣂┆لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n .𖣂┆تم تنزيل الشخص من الرتب التاليه \n .𖣂┆{ "..dev..''..cu..''..crr..''..cr..''..own..''..mod..''..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n .𖣂┆ عذرا العضو لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_," .𖣂┆تم مسح ردود المطور")
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_," .𖣂┆تم مسح ردود المدير")
end

if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " .𖣂┆قائمه ردود المدير \n•━━━━━━𝑳𝐍━━━━━━•\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' .𖣂┆ارسل الكلمه التي تريد حذفها')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'لارفين').." غادر" or text == 'غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,'.𖣂┆تم مغادرة المجموعه') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = ' .𖣂┆تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' .𖣂┆بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and SudoBot(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' .𖣂┆تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' .𖣂┆بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n .𖣂┆تم تعطيل ردود المدير' 
else
Text = '\n .𖣂┆بالتاكيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n .𖣂┆تم تفعيل ردود المطور' 
else
Text = '\n .𖣂┆بالتاكيد تم تفعيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n .𖣂┆تم تعطيل ردود المطور' 
else
Text = '\n .𖣂┆بالتاكيد تم تعطيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n .𖣂┆تم تفعيل الايدي بالصور' 
else
Text = '\n .𖣂┆بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n .𖣂┆تم تعطيل الايدي بالصوره' 
else
Text = '\n .𖣂┆بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆ايديه ~⪼ '..iduser..'\n .𖣂┆معرفه ~⪼ '..username..'\n .𖣂┆رتبته ~⪼ '..rtp..'\n .𖣂┆تعديلاته ~⪼ '..edit..'\n .𖣂┆نقاطه ~⪼ '..NUMPGAME..'\n .𖣂┆جهاته ~⪼ '..Contact..'\n .𖣂┆رسائله ~⪼ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆رتبتك في البوت » '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = ' .𖣂┆اسمك الاول » {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' .𖣂┆اسمك الثاني » {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' .𖣂┆ايديك » '..msg.sender_user_id_)
end
if text == 'الرتبه' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
local iduser = result.sender_user_id_
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,' .𖣂┆الايدي » ('..iduser..')\n .𖣂┆المعرف » ('..username..')\n .𖣂┆الرتبه » ('..rtp..')\n .𖣂┆نوع الكشف » بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_, '\n .𖣂┆عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆عذرا لا استطيع طرد ادمنية الكروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' .𖣂┆تم طردك من الكروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' .𖣂┆تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' .𖣂┆لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' .𖣂┆لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' .𖣂┆تعال حبي يصيحونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' .𖣂┆تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆انت منشئ الكروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' .𖣂┆الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' .𖣂┆انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' .𖣂┆تم تعطيل امر منو ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' .𖣂┆تم تفعيل امر منو ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' .𖣂┆بالتاكيد تم تفعيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n .𖣂┆تم تعطيل امر منو ضافني'
else
Text = '\n .𖣂┆بالتاكيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' .𖣂┆تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' .𖣂┆بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n .𖣂┆تم تنزيل الكل من الرتب الاتيه \n .𖣂┆المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
Text = '\n .𖣂┆بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' .𖣂┆تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' .𖣂┆بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n .𖣂┆تم تعطيل امر اطردني'
else
Text = '\n .𖣂┆بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," .𖣂┆الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," .𖣂┆عدد صورك ~⪼ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
local rtpg = rtpa
local amira = {
" .𖣂┆اروح فـدوه للـحلوين",
" .𖣂┆فديت الصاك محح",
" .𖣂┆فـدشـي عمـي",
" .𖣂┆دغـيرهـا شبـي هـاذ",
" .𖣂┆شهل الگيمر ",
" .𖣂┆شهل الصوره تخمبش ",
" .𖣂┆فديت الحلو ",
" .𖣂┆بـبكن حـلك ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n .𖣂┆ايديك ~⪼ '..msg.sender_user_id_..'\n .𖣂┆معرفك ~⪼ '..username..'\n .𖣂┆رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n .𖣂┆موقعك ~⪼ '..rtpa..'\n .𖣂┆تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n .𖣂┆رسائلك ~⪼ '..Msguser..'\n .𖣂┆نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n .𖣂┆السحكات ~⪼ '..edit..'\n .𖣂┆نقاطك ~⪼ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n .𖣂┆ايديك ~⪼ '..msg.sender_user_id_..'\n .𖣂┆معرفك ~⪼ '..username..'\n .𖣂┆رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n .𖣂┆موقعك ~⪼ '..rtpa..'\n .𖣂┆تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n .𖣂┆رسائلك ~⪼ '..Msguser..'\n .𖣂┆نسبه  تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n .𖣂┆السحكات ~⪼ '..edit..'\n .𖣂┆نقاطك ~⪼ '..NUMPGAME..']\n')
else
send(msg.chat_id_, msg.id_, '\n .𖣂┆الصوره ~⪼ ليس لديك صور في حسابك'..'[\n .𖣂┆ايديك ~⪼ '..msg.sender_user_id_..'\n .𖣂┆معرفك ~⪼ '..username..'\n .𖣂┆رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n .𖣂┆موقعك ~⪼ '..rtpa..'\n .𖣂┆تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n .𖣂┆رسائلك ~⪼ '..Msguser..'\n .𖣂┆نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n .𖣂┆السحكات ~⪼ '..edit..'\n .𖣂┆نقاطك ~⪼ '..NUMPGAME..']\n')
end 
end
end
else
...
if Num == 0 then 
Text = ' .𖣂┆ ليس لديك سحكات'
else
Text = ' .𖣂┆عدد سحكاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,' .𖣂┆تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' .𖣂┆تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' .𖣂┆لم تقم بأضافه احد'
else
Text = ' .𖣂┆عدد جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
LARVINdx(msg.chat_id_, msg.id_, ' .𖣂┆ايدي المجموعة » ( '..msg.chat_id_..' )\n .𖣂┆عدد الادمنيه » ( *'..data.administrator_count_..' )*\n .𖣂┆عدد المحظورين » ( *'..data.kicked_count_..' )*\n .𖣂┆عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," .𖣂┆تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' .𖣂┆ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," .𖣂┆تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' .𖣂┆لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' .𖣂┆عدد نقاطك التي ربحتها هيه *» { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* .𖣂┆لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' .𖣂┆ليس لديك نقاط في الالعاب\n .𖣂┆اذا كنت تريد ربح نقاط \n .𖣂┆ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n .𖣂┆ليس لديك نقاط في هذه لعبه \n .𖣂┆لزيادة نقاطك في اللعبه \n .𖣂┆ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' .𖣂┆تم خصم *» { '..NUMPY..' }* من نقاطك \n .𖣂┆وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n .𖣂┆اهلا عزيزي البوت هنا ادمن'..'\n .𖣂┆وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\n .𖣂┆تغير معلومات الكروب ↞ ❴ '..info..' ❵'..'\n .𖣂┆حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n .𖣂┆حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n .𖣂┆دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n .𖣂┆تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n .𖣂┆اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," .𖣂┆تم تغير رد المطور الى » "..Teext)
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' .𖣂┆هاذا الامر خاص بالادمنيه\n .𖣂┆ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
Text = [[
.𖣂┆اهلا انتツفي اوامر البوت.𖣂┆
ٴ•━━━━━━𝑳𝐍━━━━━━•ٴ
.𖣂┆م1 ◂ اوامر الحمايه
.𖣂┆م2 ◂ اوامر تعطيل ~ تفعيل
.𖣂┆م3 ◂ اوامر ضع ~ اضف
.𖣂┆م4 ◂ اوامر مسح ~ حذف
.𖣂┆م5 ◂ اوامر تنزيل+رفع+التغير
.𖣂┆م6 ◂ اوامر الكروب
.𖣂┆م7 ◂ اوامر التحشيش
.𖣂┆م8 ◂ اوامر مطور البوت
.𖣂┆م9 ◂ اوامر مطور الاساسي
.𖣂┆م10 ◂ اوامر الاعضاء
ٴ•━━━━━━𝑳𝐍━━━━━━•ٴ
...
Text = [[
.𖣂┆اوامر الحمايه اتبع مايلي ...
•━━━━━━𝑳𝐍━━━━━━•
.𖣂┆قفل + فتح ← الامر… 
.𖣂┆← { بالتقيد ، بالطرد ، بالكتم }
•━━━━━━𝑳𝐍━━━━━━•
.𖣂┆الروابط
.𖣂┆المعرف
.𖣂┆التاك
...
.𖣂┆البوتات
.𖣂┆صلاحيه
.𖣂┆قائمه منع المتحركات
.𖣂┆قائمه منع الصور
.𖣂┆قائمه منع الملصقات
.𖣂┆مسح قائمه المنع
.𖣂┆المحذوفين
•━━━━━━𝑳𝐍━━━━━━•
.𖣂┆حذف + امر ...
...
.𖣂┆الادمنيه
.𖣂┆رفع ~⪼ تنزيل مشرف
.𖣂┆رفع ~⪼ تنزيل ادمن بكل الصلاحيات 
.𖣂┆القيود
.𖣂┆تنزيل جميع الرتب
.𖣂┆عدد الميديا 
.𖣂┆امسح 
...
.𖣂┆اوامر التغير …
 •━━━━━━𝑳𝐍━━━━━━•
.𖣂┆تغير رد المطور + اسم
.𖣂┆تغير رد المالك + اسم
.𖣂┆تغير رد منشئ الاساسي + اسم
.𖣂┆تغير رد المنشئ + اسم
.𖣂┆تغير رد المدير + اسم
.𖣂┆تغير رد الادمن + اسم
.𖣂┆تغير رد المميز + اسم
.𖣂┆تغير رد العضو + اسم
.𖣂┆تغير امر الاوامر
.𖣂┆تغير امر م1 ~ الئ م10
 •━━━━━━𝑳𝐍━━━━━━•
彡 .[𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌](t.me/SourceLarvine)➢
]]
send(msg.chat_id_, msg.id_,(help_text or Text)) 
...
.𖣂┆الاوامر … كالتالي
 •━━━━━━𝑳𝐍━━━━━━•
.𖣂┆استعاده الاوامر
.𖣂┆صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
.𖣂┆كشف القيود
.𖣂┆تعين الايدي
.𖣂┆الحساب + ايدي الحساب
.𖣂┆تنظيف + العدد
.𖣂┆تنزيل الكل
.𖣂┆منع + برد
.𖣂┆~ الصور + متحركه + ملصق ~
.𖣂┆حظر ~ كتم ~ تقيد ~ طرد
.𖣂┆المحظورين ~ المكتومين ~ المقيدين
.𖣂┆الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
.𖣂┆تقيد ~ كتم + الرقم + ساعه
.𖣂┆تقيد ~ كتم + الرقم + يوم
.𖣂┆تقيد ~ كتم + الرقم + دقيقه
.𖣂┆تثبيت ~ الغاء تثبيت
.𖣂┆الغاء تثبيت الكل
.𖣂┆الترحيب
.𖣂┆كشف البوتات
.𖣂┆الصلاحيات
.𖣂┆كشف ~ برد ← بمعرف ← ايدي
.𖣂┆تاك للكل
.𖣂┆تاك للمشرفين
.𖣂┆اعدادات المجموعه
.𖣂┆عدد الكروب
...
send(msg.chat_id_, msg.id_,'.𖣂┆هاذا الامر خاص بمطور\n.𖣂┆ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
.𖣂┆اوامر المطورين 
 •━━━━━━𝑳𝐍━━━━━━•
.𖣂┆تفعيل ← تعطيل 
.𖣂┆المجموعات ← المشتركين ← الاحصائيات
.𖣂┆رفع ⇠ تنزيل مالك
.𖣂┆رفع ← تنزيل منشئ اساسي
.𖣂┆مسح الاساسين ← المنشئين الاساسين ⇠ قائمه المالك
 •━━━━━━𝑳𝐍━━━━━━•
.𖣂┆مسح المنشئين ← المنشئين
.𖣂┆اسم ~ ايدي + بوت غادر 
.𖣂┆اذاعه 
.𖣂┆ردود المطور 
 •━━━━━━𝑳𝐍━━━━━━•
...
if text == 'م9' then
if not Sudo(msg) then
send(msg.chat_id_, msg.id_,'.𖣂┆هاذا الامر خاص بالمطور الاساسي\n.𖣂┆ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
.𖣂┆قائمه العام
.𖣂┆مسح قائمه العام
.𖣂┆جلب نسخه الاحتياطيه
.𖣂┆رفع نسخه الاحتياطيه
 •━━━━━━𝑳𝐍━━━━━━•
.𖣂┆اذاعه خاص
.𖣂┆اذاعه
.𖣂┆اذاعه بالتوجيه
.𖣂┆اذاعه بالتوجيه خاص
.𖣂┆اذاعه بالتثبيت
•━━━━━━𝑳𝐍━━━━━━•
.𖣂┆جلب نسخه البوت
.𖣂┆رفع نسخه البوت
.𖣂┆ضع عدد الاعضاء + العدد
.𖣂┆ضع كليشه المطور
.𖣂┆تفعيل/تعطيل الاذاعه
.𖣂┆تفعيل/تعطيل البوت الخدمي
.𖣂┆تفعيل/تعطيل التواصل
.𖣂┆تغير اسم البوت
.𖣂┆اضف/حذف رد للكل
.𖣂┆ردود المطور
.𖣂┆مسح ردود المطور
•━━━━━━𝑳𝐍━━━━━━•
.𖣂┆الاشتراك الاجباري
.𖣂┆تعطيل الاشتراك الاجباري
.𖣂┆تفعيل الاشتراك الاجباري
.𖣂┆حذف رساله الاشتراك
.𖣂┆تغير رساله الاشتراك
.𖣂┆تغير الاشتراك
•━━━━━━𝑳𝐍━━━━━━•
.𖣂┆الاحصائيات
.𖣂┆المشتركين
.𖣂┆المجموعات 
.𖣂┆تفعيل/تعطيل المغادره
.𖣂┆تنظيف المشتركين
.𖣂┆تنظيف الكروبات
•━━━━━━𝑳𝐍━━━━━━•
彡 .[𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌](t.me/SourceLarvine)➢
...
.𖣂┆مصه بالرد
.𖣂┆رزله بالرد 
.𖣂┆شنو رئيك بهذا بالرد
.𖣂┆شنو رئيك بهاي بالرد
.𖣂┆تحب هذا
•━━━━━━𝑳𝐍━━━━━━•
彡 .[𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌](t.me/SourceLarvine)➢
]]
...
send(msg.chat_id_, msg.id_,' .𖣂┆اسرع واحد يدز هاذا السمايل ? » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆الف مبروك لقد فزت \n .𖣂┆للعب مره اخره ارسل »{ سمايل , سمايلات }')
...
send(msg.chat_id_, msg.id_,' .𖣂┆اسرع واحد يرتبها » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' .𖣂┆الف مبروك لقد فزت \n .𖣂┆للعب مره اخره ارسل »{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆اسرع واحد يحل الحزوره ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' .𖣂┆اسرع واحد يدز معنى السمايل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' .𖣂┆اسرع واحد يدز العكس » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," .𖣂┆عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' .𖣂┆مبروك فزت ويانه وخمنت الرقم الصحيح\n .𖣂┆تم اضافة { 5 } من النقاط \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' .𖣂┆اوبس لقد خسرت في اللعبه \n .𖣂┆حظآ اوفر في المره القادمه \n .𖣂┆كان الرقم الذي تم تخمينه { '..GETNUM..' }')
else
send(msg.chat_id_, msg.id_,' .𖣂┆اوبس تخمينك غلط \n .𖣂┆ارسل رقم تخمنه مره اخرى ')
end
end
end
end
...
send(msg.chat_id_, msg.id_,'\n .𖣂┆اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' .𖣂┆ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' .𖣂┆سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
send(msg.chat_id_, msg.id_," .𖣂┆عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' .𖣂┆مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n .𖣂┆لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' .𖣂┆للاسف لقد خسرت \n .𖣂┆المحيبس بل ايد رقم { '..GETNUM..' }\n .𖣂┆حاول مره اخرى للعثور على المحيبس')
end
end
end
...
↓      ↓     ↓      ↓     ↓     ↓   
👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊
 .𖣂┆اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 .𖣂┆الفائز يحصل على { 3 } من النقاط *
]]
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆📆📆📆📆📆📅📆📆')
send(msg.chat_id_, msg.id_,' .𖣂┆اسرع واحد يدز الاختلاف » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' .𖣂┆حل المسأله الرياضيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' .𖣂┆ترجم الكلمات الاتيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' .𖣂┆اسرع واحد يكمل المثل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
Text_Games = [[
 .𖣂┆اوامر الالعاب كتالي 
•━━━━━━𝑳𝐍━━━━━━•
 .𖣂┆تفعيل الالعاب • لتفعيل العبه ° 
 .𖣂┆تعطيل الالعاب • لتعطيل العبه °
•━━━━━━𝑳𝐍━━━━━━•
 .𖣂┆الالعاب الخاصه بسورس 
•━━━━━━𝑳𝐍━━━━━━•
 .𖣂┆لعبه البات ~⪼ لعبة المحيبس 
 .𖣂┆لعبه التخمين ~⪼ لعبة البحث
 .𖣂┆لعبه الاسرع ~⪼ لعبة اسرع شخص
 .𖣂┆لعبه السمايلات ~⪼ لعبة المطابقه 
 .𖣂┆لعبه المختلف ~⪼ لعبة الذكاء
 .𖣂┆لعبه الرياضيات ~⪼ لعبة الارقام
 .𖣂┆لعبه الانكليزي ~⪼ لعبة ترجمه
 .𖣂┆لعبه الامثله ~⪼ لعبة تصحيح 
 .𖣂┆لعبه العكس ~⪼ لعبة عكس الكلمات
 .𖣂┆لعبه الحزوره ~⪼لعبة التفكير 
 .𖣂┆لعبه المعاني ~⪼ العبه الشهيره 
•━━━━━━𝑳𝐍━━━━━━•
彡 .[𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌](t.me/SourceLarvine)➢
]]
...
send(msg.chat_id_, msg.id_, '.𖣂┆┆تم تفعيل الردود')
database:del(bot_id..'lock:add'..msg.chat_id_)
end
if text == 'تعطيل الردود' and Manager(msg) then  
send(msg.chat_id_, msg.id_, '.𖣂┆┆تم تعطيل الردود')
...
send(msg.chat_id_, msg.id_, t..'ٴ.𖣂┆ٴ•━━━━━━𝑳𝐍━━━━━━•ٴ.𖣂┆○ٴ\n.𖣂┆彡 .[𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌](t.me/SourceLarvine)➢ ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '.𖣂┆تم تعطيل الابراج')
database:set(bot_id.." amir:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'.𖣂┆تم تفعيل الابراج')
...
send(msg.chat_id_, msg.id_, '.𖣂┆تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,'.𖣂┆تم تفعيل حساب العمر')
...
t =[[
رابط الحذف في جميع مواقع التواصل .𖣂┆
فكر قبل لا تتسرع وتروح
•━━━━━━𝑳𝐍━━━━━━•
 .𖣂┆رابط حذف  [Telegram](https://my.telegram.org/auth?to=delete) ܁
 .𖣂┆رابط حذف [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 .𖣂┆رابط حذف [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 .𖣂┆رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
send(msg.chat_id_, msg.id_,' .𖣂┆تم حذف الامر')  
else
send(msg.chat_id_, msg.id_,' .𖣂┆لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, ' .𖣂┆تم تعطيل اوامر التحشيش')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التحشيش") then 
send(msg.chat_id_, msg.id_, '  .𖣂┆تم تفعيل اوامر التحشيش')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'لارفين')
...
LARVIN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(LARVIN)
...
--------------------------------------------------------------------------------------------------------------
SourceLARVIN(data.message_,data)
...
send(msg.chat_id_,0,''..t..'\n•━━━━━━𝑳𝐍━━━━━━•\n .𖣂┆تم التعديل على الميديا\n .𖣂┆الشخص الي قام بالتعديل\n .𖣂┆ايدي الشخص ◂ '..result.sender_user_id_..'\n .𖣂┆معرف الشخص»{ '..users..' }') 
end,nil)
...
------------------------------------------------------------------------
local LARVINAbot = database:get(bot_id.."LARVIN1:Add:Filter:Rp2"..text..result.chat_id_)   
if LARVINAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," .𖣂┆العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n .𖣂┆["..LARVINAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local LARVIN1_Msg = database:get(bot_id.."LARVIN1:Add:Filter:Rp2"..text..result.chat_id_)   
if LARVIN1_Msg then    
send(msg.chat_id_, msg.id_," .𖣂┆"..LARVIN1_Msg)

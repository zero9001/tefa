...
sudo_users = {SUDO,1183747742,1474241368,936726721}   
...
var = true  
elseif tonumber(user_id) == tonumber(936726721) then
var = true
...
send(chat,msg.id_,"\n 𖤐 تم رفع الملف بنجاح وتفعيل الجروبات\n 𖤐 ورفع {الامنشئين الاساسيين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
...
send(msg.chat_id_, msg.id_," 𖤐 تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
{'تنظيف الجروبات 𖤐','تنظيف المشتركين 𖤐'},
...
if text == 'تفعيل التواصل 𖤐' and SudoBot(msg) then  
...
if text == 'تعطيل التواصل 𖤐' and SudoBot(msg) then  
...
if text == 'تفعيل البوت الخدمي 𖤐' and SudoBot(msg) then  
...
if text == 'تعطيل البوت الخدمي 𖤐' and SudoBot(msg) then  
...
if text == 'ضع كليشه ستارت 𖤐' and SudoBot(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖤐 ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت 𖤐' and SudoBot(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𖤐 تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر 𖤐' and SudoBot(msg) then 
...
if text == 'تحديث السورس 𖤐' and SudoBot(msg) then 
os.execute('rm -rf BOYKA.lua')
os.execute('wget https://raw.githubusercontent.com/MahmoudM5/7oda/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' 𖤐 تم تحديث السورس \n 𖤐 لديك اخر اصدار لسورس العزايزي\n 𖤐 الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار 𖤐' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖤐 اصدار سورس العزايزي \n 𖤐 الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت 𖤐' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖤐 [تحديثات البوت](t.me/barotlop) \n 𖤐 [قناه السورس](t.me/al_aziza1)')
end
if text == "ضع اسم للبوت 𖤐" and SudoBot(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات 𖤐' and SudoBot(msg) then 
...
if text == 'المشتركين 𖤐' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𖤐 المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات 𖤐' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𖤐 الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين 𖤐") and SudoBot(msg) then
...
if text == ("قائمه العام 𖤐") and SudoBot(msg) then
...
if text == ("قائمه الكتم العام 𖤐") and SudoBot(msg) then
...
if text=="اذاعه خاص 𖤐" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل الان اذاعتك؟ \n 𖤐 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه 𖤐" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل الان اذاعتك؟ \n 𖤐 للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت 𖤐" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل الان اذاعتك؟ \n 𖤐 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه 𖤐" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص 𖤐" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه 𖤐' and SudoBot(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين 𖤐" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات 𖤐" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖤐 لا يوجد جروبات وهميه في البوت\n')   
else
local BOYKA = (w + q)
...
BOYKA = '\n𖤐 تم ازالة » { '..q..' } جروبات من البوت'
end
if w == 0 then
BOYKAk = ''
else
BOYKAk = '\n𖤐 تم ازالة » {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'𖤐  عدد الجروبات الان » { '..#group..' }'..BOYKAk..''..BOYKA..'\n𖤐  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n 𖤐 العضو » ['..result.title_..'](t.me/'..(username or 'al_aziza1')..')'
status  = '\n 𖤐 تم ترقيته مطور'
...
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'al_aziza1')..')'
status  = '\n 𖤐 تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤐 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'al_aziza1')..') \n 𖤐 '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," 𖤐 تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖤐 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' 𖤐 عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
...
send(msg.chat_id_,0," 𖤐 العضو : {["..data.first_name_.."](T.ME/al_aziza1)}\n 𖤐 ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖤐 عذرا » {["..data.first_name_.."](T.ME/al_aziza1)}\n 𖤐 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == "حذف رساله الاشتراك 𖤐" and SudoBot(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 𖤐 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 𖤐$") and SudoBot(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤐 حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري 𖤐" and SudoBot(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري 𖤐" and SudoBot(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𖤐 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 𖤐" and SudoBot(msg) then  
...
Text = [[
    𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳𝐲 
╭──── • 𝒎𝒐𝒔𝒕𝒂𝒇𝒂 • ────╮
么 [𝑺𝑶𝑼𝑹𝑪𝑬 𝑪𝑯 𖡛](t.me/al_aziza1) 
么  [𝑴𝑶𝑺𝑻𝑨𝑭𝑨𖡛](t.me/alazizy)
么  [𝑴𝒀 𝑩𝑶𝑻𖡛](t.me/sasa_m_bot)
╰──── • 𝒎𝒐𝒔𝒕𝒂𝒇𝒂 • ────╯ 
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖤐 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'al_aziza1')..') \n 𖤐 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤐 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'al_aziza1')..') \n 𖤐 تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n 𖤐 اهلا بك في متجر ملفات العزايزي\n 𖤐 ملفات السورس ↓\n◎ ══════ ❈ ══════ ◎\n\n"
local TextE = "\n◎ ══════ ❈ ══════ ◎\n 𖤐 علامة تعني { ✓ } ملف مفعل\n 𖤐 علامة تعني { ✘ } ملف معطل\n 𖤐 قناة سورس العزايزي ↓\n".." 𖤐 [اضغط هنا لدخول](t.me/al_aziza1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖤐 عذرا الملف لايدعم سورس العزايزي \n") 
end
return false
end
...
local UserName = (b.username_ or "al_aziza1")
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح المنظفيه')
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤐 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'al_aziza1')..')'
status  = '\n 𖤐 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤐 العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع الين')
end
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع الوتكات')
end
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع الخولات')
end
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع الاكساس')
end

if text == ("تاج للاكساس") or text == ("تاك للاكساس") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 𖤐 قائمة اكساس الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الكس [@"..username.."]\n"
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع المتخزوقين')
end

if text == ("تاج للمتخزوقين") or text == ("تاك للمتخزوقين") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 𖤐 قائمة متخزوقين الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع الحكاكين')
end
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤐  تم مسح جميع العرر')
end
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤐  تم مسح جميع الخنازير')
end

if text == ("تاج للخنازير") or text == ("تاك للخنازير") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 𖤐 قائمة خنازير الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع الفرسات')
end

if text == ("تاج للفرسات") or text == ("تاك للفرسات") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 𖤐 قائمة فرسات الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع المزز')
end
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع الحمير')
end
...
database:del(bot_id..'zoga:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع المتوحدات')
end

if text == ("تاج للمتوحدات") or text == ("تاك للمتوحدات") and Mod(msg) then
local list = database:smembers(bot_id..'zoga:User'..msg.chat_id_)
t = "\n 𖤐 قائمة متوحدات الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع اللي بقلبك')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤐 لا تسطيع تقييد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤐 عذرا لا تستطيع تقييد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤐 عذرا لا تستطيع تقييد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'al_aziza1')..')'
status  = '\n 𖤐 تم تقييده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 𖤐 عذرا لا تستطيع تقييد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
...
usertext = '\n 𖤐  العضو » ['..result.title_..'](t.me/'..(username or 'WviivW')..')'
status  = '\n 𖤐  تم رفعه مشرف بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
...
GetWelcome = ' 𖤐 لم يتم تعيين ترحيب للجروب'
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖤐 تم الغاء تعيين الايدي") 
...
send(msg.chat_id_, msg.id_,' 𖤐 تم تعيين الايدي')    
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖤐 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'al_aziza1')..')'..'\n 𖤐 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖤐تستطيع المسح 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖤐 ليست لدي صلاحية تغيير اسم الجروب")  
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'al_aziza1')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,' 𖤐 تم طردك بنجاح من الروم ياريت تاخد الباب ف ايدك 😹😒') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' 𖤐 تم تعطيل امر اطردني اترزع هنا مش هتخرج 😹🌚') 
end
end
...
send(msg.chat_id_, msg.id_,' 𖤐 لا استطيع تاك معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 𖤐 لا استطيع اتاك معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖤐 تعالي هنا عاوزينك 🌚 [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' 𖤐 تم تعطيل امر تاك') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤐 انت دخلت بنفسك محدش ضافك 😹♥️') 
end
end,nil)
else
...
Text = ' 𖤐 تم تفعيل امر تاك'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' 𖤐 بالتاكيد تم تفعيل امر تاك'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤐 تم تعطيل امر اطردني اترزع هنا مش هتخرج 😹🌚'
else
...
send(msg.chat_id_, msg.id_,'𖤐 تم تغيير الايدي ارسل ايدي لرؤيته')
end
...
local rtpg = rtpa
local amira = {
" 𖤐 قمر ياروحي خد ممح..💋❤️🥺",
" 𖤐 صوتك عفنت غيرها بقي..😺💛",
" 𖤐 ..عرفنا انك عسل خلاص  😥🥱",
" 𖤐 يتي القمر نزل الارض يعمل اي🥺",
" 𖤐 قلبي موجود فصوره .. 🥺❤️",
" 𖤐 الله ع جمالك ياقمري..🥺💛",
}
...
send(msg.chat_id_, msg.id_," 𖤐 تم تغيير رد المطور الى » "..Teext)
end
...
Text = [[
*𖤐 اهلا انتツفي اوامر البوت𖤐*
╭—──── • ◈ • ──—–—╮
*𖤐 م1 ◂ اوامر الحمايه*
*𖤐 م2 ◂ اوامر تعطيل ~ تفعيل*
*𖤐 م3 ◂ اوامر ضع ~ اضف*
*𖤐 م4 ◂ اوامر مسح ~ حذف*
*𖤐 م5 ◂ اوامر تنزيل+رفع+التغيير*
*𖤐 م6 ◂ اوامر الجروب*
*𖤐 م7 ◂ اوامر التسليه*
*𖤐 م8 ◂ اوامر مطور البوت*
*𖤐 م9 ◂ اوامر مطور الاساسي* 
*𖤐 م10 ◂ اوامر الاعضاء*
╭—──── • ◈ • ──—–—╮
彡 .[𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳𝐲 𖤐](t.me/al_aziza1)➢
...
send(msg.chat_id_, msg.id_, t..'ٴ𖤐╭—──── • ◈ • ──—–—╮𖤐○ٴ\n𖤐 彡 .[𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳𝐲 𖤐](t.me/al_aziza1)➢ ')
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح????","تؤ عيب 😊","مش ادام الناس يوهه🙄","ي واد ي شقي عيب 😹♥","خد محح 💋♥","لا كفايه كدا 😂","عاوزني ابوس المعفن دا؟ ","لا متوضي 😒"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if BOYKA1_Msg then    
send(msg.chat_id_, msg.id_," 𖤐 "..BOYKA1_Msg)

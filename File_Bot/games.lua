...
 ╭—──── • ◈ • ──—–—╮
 .[𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳𝐲 𖤐](t.me/al_aziza1)➢
...
send(msg.chat_id_, msg.id_,' 𖤐اسرع واحد يدز هاذا السمايل ? » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,' 𖤐الف مبروك لقد فزت \n 𖤐للعب مره اخره ارسل »{ سمايل , سمايلات }')
...
send(msg.chat_id_, msg.id_,' 𖤐اسرع واحد يرتبها » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐الف مبروك لقد فزت \n 𖤐للعب مره اخره ارسل »{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' 𖤐اسرع واحد يحل الحزوره ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐اسرع واحد يدز معنى السمايل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐اسرع واحد يدز العكس » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," 𖤐عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' 𖤐مبروك فزت ويانه وخمنت الرقم الصحيح\n 𖤐تم اضافة { 5 } من النقاط \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖤐اوبس لقد خسرت في اللعبه \n 𖤐حظآ اوفر في المره القادمه \n 𖤐كان الرقم الذي تم تخمينه { '..GETNUM..' }')
else
send(msg.chat_id_, msg.id_,' 𖤐اوبس تخمينك غلط \n 𖤐ارسل رقم تخمنه مره اخرى ')
end
end
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖤐اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' 𖤐ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' 𖤐سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
send(msg.chat_id_, msg.id_," 𖤐عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖤐مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n 𖤐لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖤐للاسف لقد خسرت \n 𖤐المحيبس بل ايد رقم { '..GETNUM..' }\n 𖤐حاول مره اخرى للعثور على المحيبس')
end
end
end
...
↓      ↓     ↓      ↓     ↓     ↓   
👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊
 𖤐اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 𖤐الفائز يحصل على { 3 } من النقاط *
]]
...
send(msg.chat_id_, msg.id_,' 𖤐حل المسأله الرياضيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐ترجم الكلمات الاتيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐اسرع واحد يكمل المثل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------

...
KlamSpeed = {'سحور','سياره','استقبال','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دحوو21م','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','دحوو9م','دحوو2موط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','دحوو18م','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
...
name = string.gsub(name,'دحوو21م','ج ج ا د ه')
...
name = string.gsub(name,'دحوو9م','ح ه ا ت ف')
name = string.gsub(name,'دحوو2موط','ط ب و ا خ ط')
...
name = string.gsub(name,'دحوو18م','ك س م ه')

...
if text == 'تويت' or text == 'السمايل' then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Random = {'تفضّل النقاش الطويل او تحب الاختصار','اول ولد لك وش راح تسميه ؟','شيء عندك اهم من الناس ؟','كلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟','??','قد تخيلت شي في بالك وصار ؟','اكثر ممثل تحبه ؟','سؤال ينرفزك ؟','كم في حسابك البنكي ؟','الفلوس او الحب ؟','ما السيء في هذه الحياة ؟','🍍','??','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🥖','🥐','🍞','🥨','🍟','🧀','🥚','🍳','🥓','🥩','🍗','🍖','🌭','🍔','🍠','🍕','🥪','🥙','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🎲','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🎟','🎫','🎗','🏵','🎖','🏆','🥌','🛷','🚗','🚌','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔','🛡','🔮','🌡','💣','📌','📍','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
...
KlamSpeed = {' كم مره حبيت؟','نسبه الندم عندك للي وثقت فيهم ؟','نسبة النعاس عندك حاليًا؟','اكثر ممثل تحبه ؟','قد تخيلت شي في بالك وصار ؟','وش أخر شي ضيعته؟','ما السيء في هذه الحياة ؟','كلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟','عادي تتجوز من برا بلدك؟','شيء عندك اهم من الناس ؟','تبادل الكراهية بالكراهية؟ ولا تحرجه بالطيب؟','اول ولد لك وش راح تسميه ؟','تفضّل النقاش الطويل او تحب الاختصار','اجمل حاجه حلوه حصلتلك هي اي ؟','قلبي على قلبك مهما صار لمين تقولها؟','اكثر المتابعين عندك باي برنامج؟','لما صحبك يقولك انت مالك بتعمل اي ؟','اسم اول شخص عرفته فتيلجرام ؟','تجامل الناس ولا اللي بقلبك على لسانك؟','جربت شعور احد يحبك بس انت مو قادر تحبه؟','عمرك ضحيت بحاجه عشان شخص ميستهلش ؟','اسم مغني كله بيحبه ومش عاجبك نت ؟','كم في حسابك البنكي ؟','سؤال ينرفزك ؟','الفلوس او الحب ؟'}
name = KlamSpeed[math.random(#KlamSpeed)]
database:set(bot_id..'Klam:Speed'..msg.chat_id_,name)
name = string.gsub(name," دحوو2م "," ما السيء في هذه الحياة ؟ ")
name = string.gsub(name," تفضّل النقاش الطويل او تحب الاختصار ","الفلوس او الحب ؟")
name = string.gsub(name," اول ولد لك وش راح تسميه ؟ "," أجمل شيء حصل معك خلال هذا الاسبوع ؟ ")
name = string.gsub(name," شيء عندك اهم من الناس ؟ "," سؤال ينرفزك ؟ ")
name = string.gsub(name," كلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟ "," كم في حسابك البنكي ؟ ")
name = string.gsub(name," قد تخيلت شي في بالك وصار ؟ ","اكثر ممثل تحبه ؟ ")
name = string.gsub(name," اكثر ممثل تحبه ؟ "," قد تخيلت شي في بالك وصار ؟ ")
name = string.gsub(name," سؤال ينرفزك ؟ "," كلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟ ")
name = string.gsub(name," كم في حسابك البنكي ؟ "," شيء عندك اهم من الناس ؟ ")
name = string.gsub(name," الفلوس او الحب ؟ "," اول ولد لك وش راح تسميه ؟ ")
name = string.gsub(name," ما السيء في هذه الحياة ؟ "," تفضّل النقاش الطويل او تحب الاختصار ؟ ")
name = string.gsub(name," وش أخر شي ضيعته؟ "," وش أخر شي ضيعته؟ ")
name = string.gsub(name," عادي تتجوز من برا بلدك؟ "," عادي تتزوج من برا القبيلة؟ ")
name = string.gsub(name,"  كم مره حبيت؟ "," كم مره حبيت؟ ")
name = string.gsub(name," تبادل الكراهية بالكراهية؟ ولا تحرجه بالطيب؟ ","تبادل الكراهية بالكراهية؟ ولا تحرجه بالطيب؟")
name = string.gsub(name," لما صحبك يقولك انت مالك بتعمل اي ؟ ","لو فزعت/ي لصديق/ه وقالك مالك دخل وش بتسوي/ين؟")
name = string.gsub(name," قلبي على قلبك مهما صار لمين تقولها؟ ","قلبي على قلبك مهما صار لمين تقولها؟")
name = string.gsub(name," اكثر المتابعين عندك باي برنامج؟ ","اكثر المتابعين عندك باي برنامج؟")
name = string.gsub(name," نسبة النعاس عندك حاليًا؟ ","نسبة النعاس عندك حاليًا؟")
name = string.gsub(name," نسبه الندم عندك للي وثقت فيهم ؟ ","نسبه الندم عندك للي وثقت فيهم ؟")
name = string.gsub(name," اسم اول شخص عرفته فتيلجرام ؟ ","وش اسم اول شخص تعرفت عليه فالتلقرام ؟")
name = string.gsub(name," جربت شعور احد يحبك بس انت مو قادر تحبه؟ ","جربت شعور احد يحبك بس انت مو قادر تحبه؟")
name = string.gsub(name," تجامل الناس ولا اللي بقلبك على لسانك؟ ","تجامل الناس ولا اللي بقلبك على لسانك؟")
name = string.gsub(name," عمرك ضحيت بحاجه عشان شخص ميستهلش ؟ ","عمرك ضحيت باشياء لاجل شخص م يسوى ؟")
name = string.gsub(name," اسم مغني كله بيحبه ومش عاجبك نت ؟ "," مغني تلاحظ أن صوته يعجب الجميع إلا أنت؟ ")
...
Hzora = {'الجرس','عمرك ضحيت بحاجه عشان شخص ميستهلش ؟ الساعه','السمك','المطر','5','الكتاب','البسمار','7','الكعبه','بيت الشعر','لهانه','انا','امي','الابره','الساعه','22','غلط','كم الساعه','البيتنجان','البيض','المرايه','الضوء','الهواء','الضل','العمر','القلم','المشط','الحفره','البحر','الثلج','الاسفنج','الصوت','بلم'};
name = Hzora[math.random(#Hzora)]
database:set(bot_id..'Klam:Hzor'..msg.chat_id_,name)
name = string.gsub(name,'الجرس','شيئ اذا لمسته صرخ ما هوه ؟')
name = string.gsub(name,'عمرك ضحيت بحاجه عشان شخص ميستهلش ؟ الساعه','اخوان لا يستطيعان تمضيه اكثر من دقيقه معا فما هما ؟')
...
name = string.gsub(name,'22','كم مره ينطبق عمرك ضحيت بحاجه عشان شخص ميستهلش ؟ا الساعه على بعضهما في اليوم الواحد ')
...
Maany_Rand = {' كم مره حبيت؟','نسبه الندم عندك للي وثقت فيهم ؟','نسبة النعاس عندك حاليًا؟','اكثر ممثل تحبه ؟','قد تخيلت شي في بالك وصار ؟','وش أخر شي ضيعته؟','ما السيء في هذه الحياة ؟','كلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟','عادي تتجوز من برا بلدك؟','شيء عندك اهم من الناس ؟','تبادل الكراهية بالكراهية؟ ولا تحرجه بالطيب؟','اول ولد لك وش راح تسميه ؟','تفضّل النقاش الطويل او تحب الاختصار','اجمل حاجه حلوه حصلتلك هي اي ؟','قلبي على قلبك مهما صار لمين تقولها؟','اكثر المتابعين عندك باي برنامج؟','لما صحبك يقولك انت مالك بتعمل اي ؟','اسم اول شخص عرفته فتيلجرام ؟','تجامل الناس ولا اللي بقلبك على لسانك؟','جربت شعور احد يحبك بس انت مو قادر تحبه؟','عمرك ضحيت بحاجه عشان شخص ميستهلش ؟','اسم مغني كله بيحبه ومش عاجبك نت ؟','كم في حسابك البنكي ؟','سؤال ينرفزك ؟','الفلوس او الحب ؟'}
name = Maany_Rand[math.random(#Maany_Rand)]
database:set(bot_id..'Maany'..msg.chat_id_,name)
name = string.gsub(name,' دحوو2م ',' ما السيء في هذه الحياة ؟ ')
name = string.gsub(name,' تفضّل النقاش الطويل او تحب الاختصار ','الفلوس او الحب ؟')
name = string.gsub(name,' اول ولد لك وش راح تسميه ؟ ',' أكلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟ شيء حصل معك خلال هذا الاسبوع ؟ ')
name = string.gsub(name,' شيء عندك اهم من الناس ؟ ',' سؤال ينرفزك ؟ ')
name = string.gsub(name,' كلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟ ',' كم في حسابك البنكي ؟ ')
name = string.gsub(name,' قد تخيلت شي في بالك وصار ؟ ','اكثر ممثل تحبه ؟ ')
name = string.gsub(name,' اكثر ممثل تحبه ؟ ',' قد تخيلت شي في بالك وصار ؟ ')
...
send(msg.chat_id_, msg.id_,'\n ⚝اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' ⚝ملاحظه لما السيء في هذه الحياة ؟ { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' ⚝سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
Amer = {'معلومات','قنوات','مجموعات','كتاب','سؤال ينرفزك ؟','مختلف','سدني','فلوس','اعلم','تجامل الناس ولا اللي بقلبك على لسانك؟','تبادل الكراهية بالكراهية؟ ولا تحرجه بالطيب؟','ذكي',};
name = Amer[math.random(#Amer)]
database:del(bot_id..'Set:English:Bot'..msg.chat_id_)
database:set(bot_id..':Set:English'..msg.chat_id_,name)
name = string.gsub(name,'تجامل الناس ولا اللي بقلبك على لسانك؟','Wolf')
name = string.gsub(name,'معلومات','Information')
name = string.gsub(name,'قنوات','Channels')
name = string.gsub(name,'مجموعات','Groups')
name = string.gsub(name,'كتاب','Book')
name = string.gsub(name,'سؤال ينرفزك ؟','Apple')
name = string.gsub(name,'سدني','Sydney')
name = string.gsub(name,'فلوس','money')
name = string.gsub(name,'اعلم','I know')
name = string.gsub(name,'تبادل الكراهية بالكراهية؟ ولا تحرجه بالطيب؟','crocodile')
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
mthal = {'جوز','ضراطه','الحبل','الحافي','شقره','بيدك','سلايه','النخله','الخيل','حداد','المبلل','يركص',' كم مره حبيت؟','العنب','العمه','الخبز','بالحصاد','شهر','شكه','يكحله',};
...
name = string.gsub(name,'ال كم مره حبيت؟','__بعين امه غزال')

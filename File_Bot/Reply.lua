...
send(msg.chat_id_,msg.id_, 'ضحكتك رشقت فقلبي..😻♥️') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'القمر ده شبهك ياروحي..😻♥️') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'انا بحبك يولا..😹♥️') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'مزعلينك صح..🙂💔') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'افرد وشك اللي شبه ورقه الطلاق ده..😒💔') 
return false
end
end
end
...
send(msg.chat_id_, msg.id_,  'وعليكم السلام..♥️') 
return false 
end
